...
pm2 delete telegram-bot-server telegram-message-forwarder father-time-forwarder 2>/dev/null || true
...
echo "To stop the applications, use: pm2 delete telegram-bot-server telegram-message-forwarder father-time-forwarder"
